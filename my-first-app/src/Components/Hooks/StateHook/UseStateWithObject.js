  ...
  return (
    <div>
      ...
      <input type="text" onChange={(e) => setObj({ lName: e.target.value })} /> */}
        ...
        <input type="text" onChange={(e) => setObj({... obj, fName: e.target.value })} />
      <input type="text" onChange={(e) => setObj({...obj, lName: e.target.value })} />
      <p>
        FirstName: <i><b>{obj.fName}</b></i> LastName: <i><b>{obj.lName}</b></i>
      </p>
    </div>
  );
}
